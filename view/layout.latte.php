...
<head>
    ...
    <title>{block title}{/block} :: SICII ::</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;" role="presentation">
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        ...
                        <img src="http://app2.sicii.com.mx/img/slide-1.jpg" width="600" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 600px;">
                    </td>
                </tr>
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;" role="presentation">
                <tr>
                    <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #888888;">
                        UCIL Universidad Científica e Idiomas de América Latína.<br><span class="mobile-link--footer">Av. Circunvalación Pichucalco No. 166, Col. Moctezuma, Tuxtla Gutiérrez, Chiapas.</span><br><span class="mobile-link--footer">(961) 61-1602, 61-1625</span>
                    </td>
                </tr>
            </table>
            <!-- Email Footer : END -->
